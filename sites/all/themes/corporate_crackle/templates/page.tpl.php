    ...
    <div class="navbar navbar-default mega-menu" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- Logo -->
          <?php if ($logo): ?>
            <a class="logo navbar-brand" href="<?php print $front_page; ?>"
          ...
          <?php if ($site_name || $site_slogan): ?>
            <div
              id="name-and-slogan"<?php if ($hide_site_name && $hide_site_slogan) {
    ...
    <?php if ($breadcrumb): ?>
      <div id="breadcrumb" class="breadcrumbs">
        <div class="container">
          ...
          <?php if ($title): ?>
            <h1 class="title pull-left" id="page-title">
              <?php print $title; ?>
            </h1>
          <?php endif; ?>
  ...
  <div class="container content-sm">
    ...
    <div class="row margin-bottom-30">
      <?php if (!empty($page['sidebar_first'])): ?>
        <div class="<?php print $sidebar_first_width_classes; ?>">
      ...
      <?php endif; ?>
      <div class="<?php print $content_width_classes; ?> md-margin-bottom-40">
        <div class="headline">
          <?php print render($title_prefix); ?>
          <?php if ($title): ?>
      ...
      <?php if (!empty($page['sidebar_second'])): ?>
        <div class="<?php print $sidebar_second_width_classes; ?>">
          <div id="sidebar-second" class="column sidebar">
            <div class="section">
